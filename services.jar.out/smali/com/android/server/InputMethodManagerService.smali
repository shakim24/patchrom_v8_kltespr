...
.method private updateSystemUiLocked(Landroid/os/IBinder;II)V
    ...
    .line 1793
    .local v7, "needsToShowImeSwitcher":Z
    move-object/from16 v0, p0
    ...
    .line 1795
    const-string/jumbo v14, "navigation_bar_ime_button"
    ...
    invoke-virtual {v13, v0, v1, v2, v8}, Lcom/android/server/statusbar/StatusBarManagerService;->setImeWindowStatus(Landroid/os/IBinder;IIZ)V
    ...
    .line 1804
    invoke-static {v13, v6, v14}, Lcom/android/internal/inputmethod/InputMethodUtils;->getImeAndSubtypeDisplayName(Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodSubtype;)Ljava/lang/CharSequence;
    ...
    iget-object v13, v0, Lcom/android/server/InputMethodManagerService;->mWindowManagerService:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v13}, Lcom/android/server/wm/WindowManagerService;->hasNavigationBar()Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v7    # "needsToShowImeSwitcher":Z
    :cond_4
    const/16 p2, 0x0
    ...
    .line 1794
    .restart local v7    # "needsToShowImeSwitcher":Z
    :cond_5
    const/4 v8, 0x0

    .restart local v8    # "showIMEButton":Z
    goto :goto_1
    ...
    .line 1812
    const-string/jumbo v14, "status_bar_ime_notification"
    ...
    .line 1813
    .local v9, "showIMENotification":Z
    :goto_4
    if-eqz v9, :cond_3
    ...
    .end local v6    # "imi":Landroid/view/inputmethod/InputMethodInfo;
    .end local v7    # "needsToShowImeSwitcher":Z
    .end local v9    # "showIMENotification":Z
    .end local v10    # "summary":Ljava/lang/CharSequence;
    .end local v11    # "title":Ljava/lang/CharSequence;
    :catchall_0
    move-exception v13
    ...
    .restart local v9    # "showIMENotification":Z
    goto :goto_4
